...
export function TopPlayers({ topPlayers }: { topPlayers: any[] }) {
	...
	return (
		<div className="mb-10">
			...
			{/* Responsive grid: 3 cols on md+, 1 col on xs */}
			<div className="grid grid-cols-3 gap-6 items-end sm:grid-cols-3 xs:grid-cols-1 xs:gap-6 xs:items-stretch">
				{positions.map((position, idx) => {
					...
					return (
						<Card
							...
							} xs:mb-6 xs:w-full xs:max-w-[340px] xs:mx-auto`}
						>
							...
							<CardContent className="p-6 pt-8 xs:p-4 xs:pt-8">
									...
									<div className="w-full mt-6 space-y-4 xs:mt-3 xs:space-y-2">
										<div className="bg-black/30 rounded-lg p-3 xs:p-2">
											...
											<div className="flex items-center">
												...
												/>
												<p className="font-bold text-cyan-400 xs:text-sm xs:truncate xs:max-w-[80px]">
										...
										<div className="bg-black/30 rounded-lg p-3 xs:p-2">
											...
											<div className="flex items-center">
												<Image
													...
													className="mr-1 xs:w-4 xs:h-4"
												/>
												<p className="font-bold text-yellow-400 xs:text-sm xs:truncate xs:max-w-[80px]">
