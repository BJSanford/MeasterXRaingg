			...
			<div className="container mx-auto max-w-7xl">
				<div className="text-center mb-12">
					...
					<p className="text-gray-400 max-w-2xl mx-auto">
						Spend your hard-earned Measter Coins on exclusive skins, credits,
						and perks. New items added regularly!
					</p>
				</div>
					...
					{rewards.map((reward) => (
						...
						>
							<div className="relative">
								...
								<Badge className="absolute bottom-2 left-2 bg-gray-800/80">
									{reward.category}
								</Badge>
							</div>
