  ...
  return (
    <div className="w-full">
      <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 bg-gray-900/50 border border-gray-800 rounded-lg p-1 mb-4 gap-2">
          <TabsTrigger
            value="overview"
        ...
        <TabsContent value="overview" className="mt-0">
          <div className="relative w-full h-[200px] xs:h-[250px] md:h-[400px]">
            <Image
