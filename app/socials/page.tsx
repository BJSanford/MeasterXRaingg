...
// Mock YouTube video data (in a real app, this would come from the YouTube API)
const recentVideos = [
  {
    id: "video1",
    title: "INSANE CS2 CASE OPENING - $10,000 PROFIT!",
  ...
  {
    id: "video2",
    title: "How I Made $5000 From RAIN.GG In One Day",
    thumbnail: "/placeholder.svg?height=180&width=320",
    views: "32K",
    date: "1 week ago",
    duration: "12:18",
  ...
  {
    id: "video3",
    title: "Best CS2 Gambling Sites in 2025 - HUGE WINS",
    thumbnail: "/placeholder.svg?height=180&width=320",
    views: "28K",
    date: "2 weeks ago",
    duration: "18:05",
                    ...
                    <div className="flex flex-col justify-between">
                      <div>
                        ...
                        <div className="flex items-center gap-2 text-gray-400 text-sm mb-4">
                          ...
                          <span>•</span>
                          <span>{recentVideos[0].date}</span>
                        </div>
                        <p className="text-gray-300 mb-6">
                          Watch Measter's latest video showcasing incredible case openings and massive wins on Rain.gg.
                          Don't forget to use code MEASTER for exclusive bonuses!
                        </p>
                      </div>
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                        <Button asChild className="w-full bg-gradient-to-r from-red-500 to-red-700 hover:opacity-90">
                          <a href={recentVideos[0].url} target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="text-center sm:text-left">
                      ...
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                        <Button asChild className="bg-gradient-to-r from-red-500 to-red-700 hover:opacity-90">
                          <a href="https://www.youtube.com/@MeasterCS_Skins" target="_blank" rel="noopener noreferrer">
                            Subscribe
                          </a>
                        </Button>
                      </motion.div>
